package com.example.myfoodapp.data.repo

import android.util.Log
import androidx.lifecycle.MutableLiveData
import com.example.myfoodapp.data.entity.*
...
class FoodDaoRepo @Inject constructor(var fdao : FoodDao) {
    ...
    fun foodAddCart(yemek_adi : String,yemek_resim_adi : String,yemek_fiyat : Int,yemek_siparis_adet : Int,kullanici_adi : String){
        fdao.foodAddCart(yemek_adi,yemek_resim_adi,yemek_fiyat,yemek_siparis_adet,kullanici_adi).enqueue(object :
